...
def dqn(n_episodes=2000, max_t=1000, eps_start=1.0, eps_end=0.01, eps_decay=0.995):
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        if np.mean(scores_window)>=250.0:
            ...
            torch.save(agent.qnetwork_local.state_dict(), 'saved_models/train2.pth')
            break
    return scores
...
# wandb.log({"Episodes" : np.arange(len(scores))}, {"Scores": scores})
...
plt.xlabel('Episode #')
plt.show()
plt.savefig("images/train2.png", transparent=True)